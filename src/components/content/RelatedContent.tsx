...
export default function RelatedContent({ items }: Props) {
  return (
    <div className="relative left-1/2 right-1/2 -mx-[50vw] w-screen bg-gray-50 py-10 mb-10">
            ...
            {items.map((item) => {
              ...
              return (
                <Link
                  key={item._id}
                  href={href}
                  className="group block rounded-xl border border-gray-200 bg-white overflow-hidden hover:border-primary-300 transition-colors"
                >
