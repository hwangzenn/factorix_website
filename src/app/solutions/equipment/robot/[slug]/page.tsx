...
const GROUP_LABEL = "협동/직교/3축로봇"
const PROCESS_KEY = "robot"
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `${ROUTES.solutions.equipment.robot}/${slug}` },
...
export default async function RobotDetailPage({ params }: Props) {
  ...
  return (
    <ContentDetail
      ...
      backHref={ROUTES.solutions.equipment.robot}
      data={item}
