...
const CATEGORY = "장비"
const GROUP_LABEL = "쓰리롤밀"
const PROCESS_KEY = "three-roll-mill"
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `${ROUTES.solutions.equipment.threeRollMill}/${slug}` },
...
export default async function ThreeRollMillDetailPage({ params }: Props) {
  ...
  return (
    <ContentDetail
      ...
      backHref={ROUTES.solutions.equipment.threeRollMill}
      data={item}
