...
export const metadata: Metadata = {
  title: "제조자동화 시스템",
  description: "산업별 액상 제조공정·자동화 요구에 맞춘 Factorix 제조자동화 시스템",
  ...
  return (
    <div className="max-w-5xl mx-auto px-6 py-20">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between mb-6">
        <div>
          <CategoryBreadcrumb segments={["공정 솔루션", "제조자동화 시스템"]} />
          <h1 className="hidden sm:block text-4xl font-bold text-primary-800">제조자동화 시스템</h1>
        </div>
      ...
      <p className="text-lg text-gray-600 mb-12 leading-relaxed">
        Factorix의 제조자동화 시스템는 완제품 시장이 아니라 <strong className="text-primary-700 font-semibold">액상 제조공정과 자동화 요구의 유사성</strong>을 기준으로 5개 산업군에 적용됩니다.
