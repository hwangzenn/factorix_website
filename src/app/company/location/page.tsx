...
export default function LocationPage() {
  return (
    <div className="max-w-5xl mx-auto px-6 py-20">
      <p className="text-sm text-primary-700 font-medium mb-2">기업정보</p>
      ...
      <div className="bg-gray-50 rounded-xl p-6 mb-8 flex flex-col sm:flex-row sm:items-center gap-4">
        <div className="flex-1">
          <p className="text-xs font-bold text-primary-700 tracking-widest uppercase mb-2">ADDRESS</p>
        ...
        <a
          ...
          className="inline-flex items-center gap-2 px-4 py-2 border border-gray-300 text-gray-700 text-sm font-medium rounded-lg hover:border-accent hover:text-accent transition-colors shrink-0"
        >
      ...
      <Link
        ...
        className="inline-flex px-6 py-3 bg-primary-700 text-white font-semibold rounded-lg hover:bg-accent transition-colors"
      >
        방문 미팅 요청
      </Link>
    </div>
