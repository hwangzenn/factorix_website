    ...
    <div className="max-w-5xl mx-auto px-6 py-20">
      ...
      <div className="bg-gray-50 rounded-xl p-6 mb-8 flex flex-col sm:flex-row sm:items-center gap-4">
        <div className="flex-1">
          <p className="text-xs font-bold text-[#006dff] tracking-widest uppercase mb-2">ADDRESS</p>
        ...
        <a
          ...
          className="inline-flex items-center gap-2 px-4 py-2 border border-gray-300 text-gray-700 text-sm font-medium rounded-lg hover:border-[#006dff] hover:text-[#006dff] transition-colors shrink-0"
        >
      ...
      <Link
        ...
        className="inline-flex px-6 py-3 bg-[#006dff] text-white font-semibold rounded-lg hover:bg-primary-800 transition-colors"
      >
        방문 미팅 요청
      </Link>
    </div>
